...
const props = defineProps({
    ...
    numVisibile: {
        type: Number,
        default: 3,
        desc: "Number ov visible accounts in the carousel."
    },
    numScroll: {
        type: Number,
        default: 1,
        desc: "The number of accounts to scroll at a time."
    },
    showLabels: {
        type: Boolean,
        default: true,
    ...
    defaultAccountId: {
        type: [Number,String],
        default: null,
        desc: "The default selected account. Requires a unique `id` field in the account object."
    },
    totalMarketValueLabel: {
        type: String,
        default: "Total Market Value",
        desc: "The text label for the total market value field."
    },
    changeInValueLabel: {
        type: String,
        default: "Change In Value",
        desc: "The text label for the change in value field."
    },
    accountNameLabel: {
        type: String,
        default: "Account Name",
        desc: "The text label for the account name field."
    },
    accountNumberLabel: {
        type: String,
        default: "Account Number",
        desc: "The text label for the account number field."
    },
});
