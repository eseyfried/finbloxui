...
export const DismissableLayerProps = mergeProps(PrimitiveProps, {
    /**
...
const { primitiveElement, currentElement: layerElement } = usePrimitiveElement()
