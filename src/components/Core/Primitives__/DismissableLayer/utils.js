...
import { handleAndDispatchCustomEvent } from '@/modules/shared'
import { nextTick, ref, watchEffect } from 'vue'

export const PointerDownOutsideEvent = ['originalEvent']
export const FocusOutsideEvent = ['originalEvent']
...
function isLayerExist(layerElement, targetElement) {
  ...
  const mainLayer = layerElement.querySelector('[data-dismissable-layer]')
...
export function usePointerDownOutside(
  ...
  watchEffect((cleanupFn) => {
    ...
    const handlePointerDown = async (event) => {
      ...
      if (isLayerExist(element.value, event.target)) {
