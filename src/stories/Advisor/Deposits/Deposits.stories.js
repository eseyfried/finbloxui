...
/**
 * ## Overview
 * The `Deposits` component displays the total Deposits for a given account or portfolio along with the underlying Deposits transactions.
 * 
 * This component is an ideal dashboard stat component.
 * 
 * ### User Story
 * > As a user, I want to know how much Deposits my account or portfolio has generated to date including the underlying Deposits transactions
 */
 export default {
