...
const template = `
<DataPointRoot v-bind="args" class="w-1/2">
    <div class="relative flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 shadow-md">
        ...
        <div class="border-t border-blue-gray-50 p-4">
            ...
            <strong class="text-green-500"><DataPointTrend /></strong>&nbsp;since yesterday
            </p>
        </div>
    </div>
</DataPointRoot>`
...
export default {
    ...
    parameters: {
        docs: {
            description: {
                story: "Completely customize the layout and use your favorite css library.",
            },
            source: {
                code: template
            }
